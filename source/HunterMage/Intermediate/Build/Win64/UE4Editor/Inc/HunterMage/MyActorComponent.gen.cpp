...
#include "HunterMage/MyActorComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	HUNTERMAGE_API UClass* Z_Construct_UClass_UMyActorComponent_NoRegister();
	HUNTERMAGE_API UClass* Z_Construct_UClass_UMyActorComponent();
	ENGINE_API UClass* Z_Construct_UClass_UActorComponent();
	UPackage* Z_Construct_UPackage__Script_HunterMage();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_UMyActorComponent_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_HunterMage,
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMyActorComponent_Statics::ClassParams = {
		...
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_UMyActorComponent_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UMyActorComponent_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMyActorComponent, 1249003319);
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMyActorComponent(Z_Construct_UClass_UMyActorComponent, &UMyActorComponent::StaticClass, TEXT("/Script/HunterMage"), TEXT("UMyActorComponent"), false, nullptr, nullptr, nullptr);
